...
var (
	walletCommand = &cli.Command{
		...
		ArgsUsage: "",
		Description: `
    yottaflux wallet import /path/to/my/presale.wallet
...
`,
			},
			{
				...
				Description: `
    yottaflux account update <address>
...
For non-interactive use the password can be specified with the --password flag:
    ...
    yottaflux account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    yottaflux account import <keyfile>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    yottaflux account import [options] <keyfile>
