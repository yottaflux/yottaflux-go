		...
		Subcommands: []*cli.Command{
			{
				...
				Description: `
yottaflux snapshot prune-state <state-root>
...
during the use of Yottaflux, please also specify it here for correct deletion. Otherwise
...
`,
			},
			{
				...
				Description: `
yottaflux snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
yottaflux snapshot check-dangling-storage <state-root> traverses the snap storage 
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
yottaflux snapshot inspect-account <address | hash> checks all snapshot layers and prints out
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
yottaflux snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
yottaflux snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'yottaflux dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'yottaflux dump', but uses the snapshots
