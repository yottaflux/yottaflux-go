...
// Tests that initializing Yottaflux with a custom genesis block and chain definitions
// work properly.
func TestCustomGenesis(t *testing.T) {
	for i, tt := range customGenesisTests {
		...
		runYottaflux(t, "--datadir", datadir, "init", json).WaitExit()

		// Query the custom genesis block
		geth := runYottaflux(t, "--networkid", "1337", "--syncmode=full", "--cache", "16",
